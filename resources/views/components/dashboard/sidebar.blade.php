<div class="relative min-h-screen">
    ...
    <aside
        ...
        class="fixed lg:sticky top-0 left-0 h-screen w-72 bg-white border-r border-neutral-200 shadow-soft flex flex-col z-40"
        style="display: none;"
    >
                ...
                <div class="space-y-6">
                    @foreach($navigationGroups as $section => $items)
                        <div class="space-y-2.5">
                            <p class="px-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-neutral-400">{{ $section }}</p>

                            <div class="space-y-1">
                                @foreach($items as $item)
                                    <a
                                        href="{{ $item['href'] }}"
                                        class="group relative flex items-center gap-3 rounded-2xl px-3.5 py-2.5 text-sm font-semibold transition-colors duration-150
                                            {{ $item['active']
                                    ...
                                    >
                                        ...
                                        <span class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl {{ $item['active'] ? 'bg-white/15' : 'bg-neutral-100 group-hover:bg-white' }}">
                                            @switch($item['icon'])
                                                @case('home')
            ...
            <div class="border-t border-neutral-200 p-4">
                <div class="rounded-2xl border border-neutral-200 bg-neutral-50 p-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs font-medium text-neutral-500 truncate">
                            {{ $roleLabel }}
                        </p>
                        <p class="mt-1 text-xs text-neutral-400 truncate">
