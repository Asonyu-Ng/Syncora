<div class="space-y-6">
    <div>
        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Task Assignment</h1>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Create/list stub</p>
    </div>

    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-1">
            <x-widget title="New Task">
                <div class="space-y-3">
                    <input
                        type="text"
                    ...
                    <input
                        type="text"
                        wire:model.defer="assignee"
                        placeholder="Assignee (intern name)"
                        class="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                    <button
                        type="button"
        ...
        <div class="lg:col-span-2">
            <x-widget title="Assigned Tasks" :collapsible="true">
                <x-dashboard.table
                    :columns="[
