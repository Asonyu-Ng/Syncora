        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-card sm:p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-neutral-900">{{ $summary['active'] ?? 0 }}</p>
                </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-card sm:p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-neutral-900">{{ $summary['inactive'] ?? 0 }}</p>
                </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-card sm:p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-neutral-900">{{ $summary['not_active'] ?? 0 }}</p>
                </div>
            ...
            <p class="mt-2 text-[13px] leading-5 text-neutral-600">No updates for 15+ days</p>
        </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-card sm:p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-neutral-900">{{ $summary['logbooks_this_week'] ?? 0 }}</p>
                </div>
            ...
            <p class="mt-2 text-[13px] leading-5 text-neutral-600">Entries submitted in the current week</p>
        </div>
        ...
        <div class="rounded-2xl border border-neutral-200 bg-white p-4 shadow-card sm:p-5">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-2 text-3xl font-semibold text-neutral-900">{{ $summary['tasks_completed_this_week'] ?? 0 }}</p>
                </div>
            ...
            <p class="mt-2 text-[13px] leading-5 text-neutral-600">Completed tasks in the current week</p>
        </div>
    </div>
    ...
    <div class="space-y-3 rounded-2xl border border-neutral-200 bg-neutral-50/70 p-4">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <p class="text-[13px] leading-5 text-neutral-500 lg:text-right">
                Narrow the list to spot inactive interns, overloaded placements, or teams that need quicker follow-up.
            </p>
        </div>
    ...
    <div class="rounded-2xl border border-neutral-200 bg-white shadow-card">
        <div class="flex items-start justify-between gap-3 px-5 py-4 sm:px-6">
            <div class="min-w-0">
                ...
                <p class="mt-1 text-[13px] leading-5 text-neutral-600">{{ $rows->total() }} interns in the current view with engagement and progress signals.</p>
            </div>
        </div>
